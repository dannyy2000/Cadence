...
- [x] Wallet connect — injected-provider connection (MetaMask etc.) via plain viem, network mismatch detection with a one-click switch/add for Unichain Sepolia, auto-reconnect on return visits. Verified end-to-end alongside the trade form above.
